...
:::warning Quyền hạn
Hầu hết jsAPI yêu cầu **phê duyệt quyền** từ Tammi Superapp. Xem [Quyền hạn và phê duyệt](./1_truoc_khi_bat_dau) trước khi sử dụng.
:::
...
1. **Mới bắt đầu?** → Đọc [Trước khi bắt đầu](./1_truoc_khi_bat_dau) để hiểu về quyền hạn
